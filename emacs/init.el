...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui lsp-mode magit all-the-icons-ivy-rich all-the-icons
	    rainbow-delimiters helpful which-key doom-modeline
	    use-package shrink-path doom-themes dired-hide-dotfiles
	    compat)))
(custom-set-faces
