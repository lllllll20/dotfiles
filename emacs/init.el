...
(custom-set-variables
 ...
 '(package-selected-packages
   '(magit all-the-icons-ivy-rich all-the-icons rainbow-delimiters ivy-rich helpful which-key doom-modeline use-package shrink-path doom-themes dired-hide-dotfiles counsel-projectile compat)))
(custom-set-faces
